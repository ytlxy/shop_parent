                                ...
                                <c:forEach items="${user2}" var="user">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                                <%--                                            修改商品--%>
                                            <a href="${pageContext.request.contextPath}/user/findById.do?id=${user.id}"><i class="far fa-edit text-info mr-1"></i></a>
                                                <%--                                            删除商品--%>
                                            <a href="${pageContext.request.contextPath}/user/deleteUser.do?id=${user.id}"><i class="far fa-trash-alt text-danger"></i></a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
