                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">发布支持信息</li>
                            </ol>
                        </div>
                        <h4 class="page-title">发布支持信息</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="${pageContext.request.contextPath}/help/addhelp.do">
                                        <div class="form-group">
                                            <label for="projectName">支持信息名称 :</label>
                                            <input type="text" class="form-control" id="projectName"
                                                   aria-describedby="emailHelp" placeholder="输入名称" name="help_name">
                                        </div><!--end form-group-->
                                        <div class="form-group">
                                            <label for="projectName">支持信息URL :</label>
                                            <input type="text" class="form-control" id="projecturl"
                                                   aria-describedby="emailHelp" placeholder="输入网址" name="help_url">
                                        </div><!--end form-group-->
