...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/lnr-icon.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/owl.carousel.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/slick.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/trumbowyg.min.css">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-6 v_middle">
                    <div class="logo">
                        <a href="${pageContext.request.contextPath}/index.jsp">
                            <img src="${pageContext.request.contextPath}/images/logo.png" alt="logo image" class="img-fluid">
                        </a>
                    </div>
                </div>
                <!-- end /.col-md-3 -->
                ...
                <div class="col-lg-8 offset-lg-1 col-md-9 col-6 v_middle">
                    ...
                    <div class="author-area">
                        <a href="${pageContext.request.contextPath}/pages/open/register.jsp" class="author-area__seller-btn inline">成为买家</a>
                                ...
                                <li class="has_dropdown">
                                    ...
                                    <div class="dropdowns notification--dropdown">
                                        ...
                                        <div class="dropdown_module_header">
                                            ...
                                            <a href="notification.html">查看全部</a>
                                        </div>
                                        ...
                                        <div class="notifications_module">
                                            <div class="notification">
                                                <div class="notification__info">
                                                    <div class="info_avatar">
                                                        <img src="${pageContext.request.contextPath}/images/notification_head.png" alt="">
                                                    </div>
                                                    <div class="info">
                                                        <p>
                                            ...
                                            <div class="notification">
                                                <div class="notification__info">
                                                    <div class="info_avatar">
                                                        <img src="${pageContext.request.contextPath}/images/notification_head2.png" alt="">
                                                    </div>
                                                    <div class="info">
                                                        <p>
                                            ...
                                            <div class="notification">
                                                <div class="notification__info">
                                                    <div class="info_avatar">
                                                        <img src="${pageContext.request.contextPath}/images/notification_head3.png" alt="">
                                                    </div>
                                                    <div class="info">
                                                        <p>
                                            ...
                                            <div class="notification">
                                                <div class="notification__info">
                                                    <div class="info_avatar">
                                                        <img src="${pageContext.request.contextPath}/images/notification_head4.png" alt="">
                                                    </div>
                                                    <div class="info">
                                                        <p>
                                                            <span>Anderson</span> added to Favourite
                                    ...
                                    <div class="dropdowns messaging--dropdown">
                                        ...
                                        <div class="messages">
                                            ...
                                            <a href="message.html" class="message recent">
                                                <div class="message__actions_avatar">
                                                    <div class="avatar">
                                                        <img src="${pageContext.request.contextPath}/images/notification_head5.png" alt="">
                                                    </div>
                                                </div>
                                                <!-- end /.actions -->
                                            ...
                                            <a href="message.html" class="message">
                                                <div class="message__actions_avatar">
                                                    <div class="avatar">
                                                        <img src="${pageContext.request.contextPath}/images/notification_head6.png" alt="">
                                                    </div>
                                                </div>
                                                <!-- end /.actions -->
                                        ...
                                        <div class="cart_area">
                                            <div class="cart_product">
                                                <div class="product__info">
                                                    <div class="thumbn">
                                                        <img src="${pageContext.request.contextPath}/images/capro1.jpg" alt="cart product thumbnail">
                                                    </div>

                                                    <div class="info">
                                                        <a class="title" href="${pageContext.request.contextPath}/single-product.html">Finance and Consulting Business Theme</a>
                                                        <div class="cat">
                                                            <a href="#">
                                                                <img src="${pageContext.request.contextPath}/images/catword.png" alt="">Wordpress</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="cart_product">
                                                <div class="product__info">
                                                    <div class="thumbn">
                                                        <img src="${pageContext.request.contextPath}/images/capro2.jpg" alt="cart product thumbnail">
                                                    </div>
                        ...
                        <div class="author-author__info inline has_dropdown">
                            <div class="author__avatar">
                                <img src="${pageContext.request.contextPath}/images/usr_avatar.png" alt="user avatar">
                                            ...
                                            <div class="menu_items">
                                                ...
                                                <div class="menu_column">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="${pageContext.request.contextPath}/404.html">404 Error page</a>
                                                        </li>
                                                        <li>
                                                            <a href="${pageContext.request.contextPath}/carieer.html">Job Posts</a>
                                                        </li>
                                                        <li>
                                                            <a href="${pageContext.request.contextPath}/job-detail.html">Job Details</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
...
<section class="hero-area bgimage">
    <div class="bg_image_holder">
        <img src="${pageContext.request.contextPath}/images/hero_area_bg1.jpg" alt="background-image">
    </div>
    <!-- start hero-content -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="hero__btn-area">
                            <a href="${pageContext.request.contextPath}/all-products.html" class="btn btn--round btn--lg">View All Products</a>
                            <a href="${pageContext.request.contextPath}/all-products.html" class="btn btn--round btn--lg">Popular Products</a>
                        </div>
                        <!-- end .hero__btn-area-->
                    </div>
                    <!-- end /.col-md-12 -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="feature">
                    <div class="feature__img">
                        <img src="${pageContext.request.contextPath}/images/feature1.png" alt="feature">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="feature">
                    <div class="feature__img">
                        <img src="${pageContext.request.contextPath}/images/feature2.png" alt="feature">
                    </div>
                    <div class="feature__title">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="feature">
                    <div class="feature__img">
                        <img src="${pageContext.request.contextPath}/images/feature3.png" alt="feature">
                    </div>
                    <div class="feature__title">
                ...
                <div class="featured-product-slider prod-slider1">
                    <div class="featured__single-slider">
                        <div class="featured__preview-img">
                            <img src="${pageContext.request.contextPath}/images/featprod.jpg" alt="Featured products">
                            <div class="prod_btn">
                                <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                        </div>
                        ...
                        <div class="featured__product-description">
                            <div class="product-desc desc--featured">
                                <a href="${pageContext.request.contextPath}/single-product.html" class="product_title">
                                    <h4>Rida - vCard, Portfolio / Resume Template</h4>
                                </a>
                                <ul class="titlebtm">
                                    <li>
                                        <img class="auth-img" src="${pageContext.request.contextPath}/images/auth.jpg" alt="author image">
                                        <p>
                                            <a href="#">AazzTech</a>
                                        </p>
                                    </li>
                    ...
                    <div class="filter__menu">
                        ...
                        <div class="filter__menu_icon">
                            <a href="#" id="drop1" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="svg" src="${pageContext.request.contextPath}/images/svg/menu.svg" alt="menu icon">
                            </a>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="product product--card">
                    ...
                    <div class="product__thumbnail">
                        <img src="${pageContext.request.contextPath}/images/p1.jpg" alt="Product Image">
                        <div class="prod_btn">
                            <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">More Info</a>
                            <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="product product--card">
                    ...
                    <div class="product__thumbnail">
                        <img src="${pageContext.request.contextPath}/images/p2.jpg" alt="Product Image">
                        <div class="prod_btn">
                            <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">More Info</a>
                            <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                        </div>
                    ...
                    <div class="product-desc">
                        ...
                        <ul class="titlebtm">
                            <li>
                                <img class="auth-img" src="${pageContext.request.contextPath}/images/auth2.jpg" alt="author image">
                                <p>
                                    <a href="#">AazzTech</a>
                                </p>
                            </li>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="product product--card">
                    ...
                    <div class="product__thumbnail">
                        <img src="${pageContext.request.contextPath}/images/p3.jpg" alt="Product Image">
                        <div class="prod_btn">
                            <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">More Info</a>
                            <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                        </div>
                    ...
                    <div class="product-desc">
                        ...
                        <ul class="titlebtm">
                            <li>
                                <img class="auth-img" src="${pageContext.request.contextPath}/images/auth3.jpg" alt="author image">
                                <p>
                                    <a href="#">AazzTech</a>
                                </p>
                            </li>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="product product--card">
                    ...
                    <div class="product__thumbnail">
                        <img src="${pageContext.request.contextPath}/images/p4.jpg" alt="Product Image">
                        <div class="prod_btn">
                            <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">More Info</a>
                            <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="product product--card">
                    ...
                    <div class="product__thumbnail">
                        <img src="${pageContext.request.contextPath}/images/p5.jpg" alt="Product Image">
                        <div class="prod_btn">
                            <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">More Info</a>
                            <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="product product--card">
                    ...
                    <div class="product__thumbnail">
                        <img src="${pageContext.request.contextPath}/images/p6.jpg" alt="Product Image">
                        <div class="prod_btn">
                            <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">More Info</a>
                            <a href="${pageContext.request.contextPath}/single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="more-product">
                    <a href="${pageContext.request.contextPath}/all-products.html" class="btn btn--lg btn--round">All New Products</a>
                </div>
            </div>
            <!-- end ./col-md-12 -->
        </div>
                ...
                <div class="product_slider">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="${pageContext.request.contextPath}/images/p6.jpg" alt="Product Image">
                            <div class="prod_btn">
                                <a href="${pageContext.request.contextPath}/single-product.jsp" class="transparent btn--sm btn--round">More Info</a>
                                <a href="${pageContext.request.contextPath}/single-product.jsp" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                            <!-- end /.prod_btn -->
                        </div>
                        <!-- end /.product__thumbnail -->
...
<section class="counter-up-area bgimage">
    <div class="bg_image_holder">
        <img src="${pageContext.request.contextPath}/images/countbg.jpg" alt="">
    </div>
    <!-- start .container -->
        ...
        <div class="row">
            <div class="col-md-6 no-padding">
                <div class="proposal proposal--left bgimage">
                    <div class="bg_image_holder">
                        <img src="${pageContext.request.contextPath}/images/bbg.png" alt="prop image">
                    </div>
                    <div class="content_above">
                        <div class="proposal__icon ">
                            <img src="${pageContext.request.contextPath}/images/buy.png" alt="Buy icon">
                        </div>
            ...
            <div class="col-md-6 no-padding">
                <div class="proposal proposal--right">
                    <div class="bg_image_holder">
                        <img src="${pageContext.request.contextPath}/images/sbg.png" alt="this is magic">
                    </div>
                    <div class="content_above">
                        <div class="proposal__icon">
                            <img src="${pageContext.request.contextPath}/images/sell.png" alt="Sell icon">
                        </div>
                        <div class="proposal__content ">
            ...
            <div class="col-md-12">
                <div class="testimonial-slider">
                    <div class="testimonial">
                        <div class="testimonial__about">
                            <div class="avatar v_middle">
                                <img src="${pageContext.request.contextPath}/images/test1.jpg" alt="Testimonial Avatar">
                            </div>
                    ...
                    <div class="testimonial">
                        <div class="testimonial__about">
                            <div class="avatar v_middle">
                                <img src="${pageContext.request.contextPath}/images/test2.jpg" alt="Testimonial Avatar">
                            </div>
                            <div class="name-designation v_middle">
                ...
                <div class="all-testimonial">
                    <a href="${pageContext.request.contextPath}/testimonial.jsp" class="btn btn--lg btn--round">View All Reviews</a>
                </div>
            </div>
            <!-- end /.col-md-12 -->
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="news">
                    <div class="news__thumbnail">
                        <img src="${pageContext.request.contextPath}/images/news1.png" alt="News Thumbnail">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="news">
                    <div class="news__thumbnail">
                        <img src="${pageContext.request.contextPath}/images/news2.png" alt="News Thumbnail">
                    </div>
                    <div class="news__content">
                        <a href="#" class="news-title">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="special-feature feature--1">
                    <img src="${pageContext.request.contextPath}/images/spf1.png" alt="Special Feature image">
            ...
            <div class="col-md-6">
                <div class="special-feature feature--2">
                    <img src="${pageContext.request.contextPath}/images/spf2.png" alt="Special Feature image">
...
<section class="call-to-action bgimage">
    <div class="bg_image_holder">
        <img src="${pageContext.request.contextPath}/images/calltobg.jpg" alt="">
    </div>
    <div class="container content_above">
        <div class="row">
            <div class="col-md-12">
...
<!-- inject:js -->
<script src="${pageContext.request.contextPath}/js/vendor/jquery/jquery-1.12.3.js"></script>
<script src="${pageContext.request.contextPath}/js/vendor/jquery/popper.min.js"></script>
<script src="${pageContext.request.contextPath}/js/vendor/jquery/uikit.min.js"></script>
<script src="${pageContext.request.contextPath}/js/vendor/bootstrap.min.js"></script>
<script src="${pageContext.request.contextPath}/js/vendor/chart.bundle.min.js"></script>
<script src="${pageContext.request.contextPath}/js/vendor/grid.min.js"></script>
<script src="${pageContext.request.contextPath}/js/vendor/jquery-ui.min.js"></script>
<script src="${pageContext.request.contextPath}/js/vendor/jquery.barrating.min.js"></script>
<script src="${pageContext.request.contextPath}/js/vendor/jquery.countdown.min.js"></script>
<script src="${pageContext.request.contextPath}/js/vendor/jquery.counterup.min.js"></script>
<script src="${pageContext.request.contextPath}/js/vendor/jquery.easing1.3.js"></script>
...
<script src="${pageContext.request.contextPath}/js/vendor/tether.min.js"></script>
<script src="${pageContext.request.contextPath}/js/vendor/trumbowyg.min.js"></script>
