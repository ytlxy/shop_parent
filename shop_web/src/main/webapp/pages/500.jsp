                        ...
                        <div class="card auth-card shadow-lg">
                            <div class="card-body">
                                <div class="px-3">
                                    ...
                                    <img src="${pageContext.request.contextPath}/assets/images/500.jpg" alt="" class="d-block mx-auto mt-4" height="250">
                                    <div class="text-center auth-logo-text mb-4">
                                        <h4 class="mt-0 mb-3 mt-5">Somthing went wrong</h4>
                                        <a onclick="history.back(-1);" class="btn btn-sm btn-gradient-primary">Back to Dashboard</a>
